...
public class charts_new_window_fragment extends Fragment implements SeekBar.OnSeekBarChangeListener  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate (R.layout.fragment_charts_new_window_fragment, null);
