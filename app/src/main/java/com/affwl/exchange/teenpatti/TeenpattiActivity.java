...
public class TeenpattiActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        TranslateAnimation animations = new TranslateAnimation(0.0f, 0.0f,
                0.0f, 150.0f);          //  new TranslateAnimation(xFrom,xTo, yFrom,yTo)
        ...
        iv_shuffle_cards=findViewById(R.id.iv_shuffle_cards);

        iv_shuffle_cards.startAnimation(animations);
